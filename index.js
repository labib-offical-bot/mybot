...
function launchBot() {
    console.clear();
    console.log(chalk.green('🚀 Starting 𝐁ᴀᴩᴩɪ xᴍᴅ system...\n'));
    ...
    if (fs.existsSync(botPath)) {
        try {
            ...
            require('./bot');
            telegramLoaded = true;
            console.log(chalk.green('✅𝐁ᴀᴩᴩɪ xᴍᴅ bot loaded successfully!'));
        } catch (error) {
    ...
    console.log(chalk.bold.white('𝐁ᴀᴩᴩɪ xᴍᴅ BOT INITIALIZATION SUMMARY          '));
    console.log(chalk.cyan('═══════════════════════════════════════════════'));
    console.log(telegramLoaded ? chalk.green('✅𝐁ᴀᴩᴩɪ xᴍᴅ тɛℓɛɢяαм вσт: Active') : chalk.red('❌𝐒ＨＡＤＯＷ тɛℓɛɢяαм вσт : Inactive'));
    ...
    if (!telegramLoaded && !whatsappLoaded) {
        ...
        console.log(chalk.green('✅ 𝐁ᴀᴩᴩɪ xᴍᴅ system is ready and running!\n'));
    }
